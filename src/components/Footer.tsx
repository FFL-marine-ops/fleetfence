      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8">
          ...
          <div className="flex-1 min-w-[220px] flex flex-col gap-4" data-aos="fade-up" data-aos-delay="100">
            <span className="font-bold text-2xl text-white">FleetFence</span>
            <span className="text-sm text-brand-lightgrey/80 max-w-xs">Delivering innovative, safe, and efficient support to the Oil & Gas and Shipping industries in the Gulf of Guinea.</span>
          ...
          <div className="flex-1 flex flex-row justify-center gap-12 min-w-[320px]" data-aos="fade-up" data-aos-delay="200">
            <div>
              <span className="font-bold text-lg text-brand-lightgrey tracking-wider">SERVICES</span>
            ...
            <div>
              <span className="font-bold text-lg text-brand-lightgrey tracking-wider">COMPANY</span>
              <ul className="mt-2 flex flex-col gap-1 text-brand-lightgrey/90">
          ...
          <div className="flex-1 min-w-[220px] flex flex-col gap-2 items-start md:items-end" data-aos="fade-up" data-aos-delay="300">
            <span className="font-bold text-lg text-brand-lightgrey tracking-wider">SUBSCRIBE TO OUR NEWSLETTER</span>
            <span className="text-sm text-brand-lightgrey/80 mb-2 md:text-right">Get the latest updates on maritime trends and company news.</span>
            <form className="flex gap-2 w-full max-w-xs md:justify-end">
              <input type="email" placeholder="Enter your email" className="px-3 py-2 rounded text-brand-darkblue w-full" />
              <button className="bg-brand-lightgrey text-brand-darkblue px-4 py-2 rounded font-semibold">Subscribe</button>
            </form>
          </div>
        </div>
        <hr className="border-brand-lightgrey/30 my-4" />
        <div className="text-xs text-brand-lightgrey/70 text-center">© {new Date().getFullYear()} FleetFence Limited. All rights reserved.</div>
      </div>
    </footer>
  );
} 