    ...
    <section className="relative w-full flex flex-col items-center justify-center bg-white text-brand-darkblue overflow-visible -mb-20 pt-8 -pb-0">
      ...
      <div className="relative z-10 flex flex-col items-center gap-1 md:gap-2 text-center w-full max-w-3xl mx-auto" data-aos="fade-down">
        ...
        <Image
          ...
          priority
        />
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold drop-shadow-lg leading-tight" data-aos="fade-up">
        ...
        <div className="flex justify-center items-center gap-1 sm:gap-2 mt-2" data-aos="fade-up" data-aos-delay="100">
          <span className="italic text-brand-teal text-base sm:text-lg md:text-xl font-semibold">Sailing Security,</span>
          <span className="text-brand-darkblue text-base sm:text-lg md:text-xl font-bold">Riding on Waves of Reliability</span>
        </div>
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold drop-shadow-lg mt-3" data-aos="fade-up" data-aos-delay="200">
        ...
        <a href="#contact" className="bg-brand-darkblue text-white px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded font-semibold shadow hover:bg-brand-lightgrey transition mt-4 mb-4 text-base sm:text-lg md:text-xl" data-aos="zoom-in" data-aos-delay="400">Request a Quote</a>
      </div>
      {/* Child Cards */}
