          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="flex flex-col gap-6" data-aos="fade-up" data-aos-delay="100">
              <form className="flex flex-col gap-4 bg-white/10 backdrop-blur-sm p-6 rounded shadow">
                <input type="text" placeholder="Name" className="px-4 py-2 rounded border" />
                <input type="email" placeholder="Email" className="px-4 py-2 rounded border" />
                <textarea placeholder="Message" className="px-4 py-2 rounded border min-h-[100px]" />
                <button type="submit" className="bg-brand-darkblue text-white px-6 py-2 rounded font-semibold hover:bg-brand-blueshade transition">Send Message</button>
              </form>
            </div>
            <div className="flex flex-col gap-6 justify-center" data-aos="fade-up" data-aos-delay="200">
              <div className="bg-white border border-brand-lightgrey/30 p-6 rounded-2xl shadow flex flex-col gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-bold text-brand-darkblue text-sm">Email:</span>
                    <div>
                      <a href="mailto:FleetFence@FleetFence.com" className="text-gray-700 text-sm">FleetFence@FleetFence.com</a>
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-bold text-brand-darkblue text-sm">Phone:</span>
                    <div>
                      <a href="tel:+2347058268955" className="text-gray-700 text-sm">+234 705 826 8955</a>
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-bold text-brand-darkblue text-sm">Address:</span>
