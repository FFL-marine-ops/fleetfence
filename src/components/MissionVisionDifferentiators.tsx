          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="flex-1">
                ...
                <p className="text-base sm:text-base md:text-lg text-gray-700 leading-relaxed">Stringent adherence to international safety standards and regulatory requirements, ensuring operations are conducted with the highest level of safety and environmental responsibility.</p>
              </div>
            </div>
            <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="flex-1">
                ...
                <p className="text-base sm:text-base md:text-lg text-gray-700 leading-relaxed">Strategic partnerships and operational capability to support maritime operations across the GoG HRA, facilitating seamless operations in diverse naval, maritime and political environments.</p>
              </div>
            </div>
            <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="300">
              ...
              <div className="flex-1">
                ...
                <p className="text-base sm:text-base md:text-lg text-gray-700 leading-relaxed">Dedicated to understanding and meeting the unique needs of each client through personalized service solutions and responsive shoreside support.</p>
              </div>
            </div>
            <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="400">
              ...
              <div className="flex-1">
                ...
                <p className="text-base sm:text-base md:text-lg text-gray-700 leading-relaxed">Continuous investment in technological advancements and modernization to enhance efficiency, reliability, and sustainability of services.</p>
              </div>
            </div>
          </div>
        </div>
