  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="apple-touch-icon" href="/fleetfence-favicon.ico" />
        <link rel="icon" type="image/x-icon" href="/fleetfence-favicon.ico" />
        <link rel="mask-icon" href="/fleetfence-favicon.ico" color="#000000" />
      </head>
      <body
